...
function Profile() {
  ...
  //     emitter.on("EVENT_CLOSE_MODAL_CHANGEPASSWORD", () => {
  //       setIsOpen(false);
  //     });
  //   };

  //   emitter.on("EVENT_CLOSE_MODAL_CHANGEPASSWORD", handleCloseModal);

  //   return () => {
  //     emitter.off("EVENT_CLOSE_MODAL_CHANGEPASSWORD", handleCloseModal);
  //   };
  // }, [setIsOpen]);
