...
function Cart() {
  ...
  useEffect(() => {
    setPricePayable(currentTotalPrice - voucherPrice + 30000);
            ...
            <>
              ...
              <div className={styles.orderElementWrapper}>
                ...
                <div className={styles.orderElement}>
                  ...
                  <TextField
                    ...
                    variant="standard"
                    value={
                      pricePayable ? currencyFormatter.format(pricePayable) : 0
                    }
                    inputProps={{
                      style: { textAlign: "right", fontSize: "2rem" },
                    }}
              ...
              >
                {paymentValue === "PAYPAL" && isScript ? (
                  <PayPalButton
                    amount={Math.round(pricePayable / 24000)}
